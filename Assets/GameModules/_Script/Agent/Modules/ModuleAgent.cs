...
{
    public class ModuleAgent : MonoBehaviour // ModuleOwner와 동일한 기능을 함.
    {
        ...
        protected virtual void AfterInitialize()
        {
            ...
            foreach (ILateInitialize module in modules.Values.OfType<ILateInitialize>()) // Dictionary들 중, ILateInitialize를 가지고 있는 애들만 선별한다. (OfType)
            {
