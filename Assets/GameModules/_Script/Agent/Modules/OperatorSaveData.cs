...
using _Script.ScriptableObject.Datas.OperatorData;
using _Script.ScriptableObject.Event;
using UnityEngine;

namespace _Script.Agent.Modules
{
    public class OperatorSaveData : MonoBehaviour, IModule, ISaveable
    {
        ...
        // private void Awake()
        // {
        //     ExpUpEventChannel.AddListener<AddExpEvent>(HandleAddExpEvent);
        // }
        //
        // private void HandleAddExpEvent(AddExpEvent evt)
        // {
        //     Exp += evt.Amount;
        //
        //     while (TryLevelUp())
        //     {
        //         _agent.ExpUpEventChannel.RaiseEvent(OperatorEvents.LevelUpEvent.Init(Level));
        //     }
        // }
        //
        ...
        // {
        //     ExpUpEventChannel.RemoveListener<AddExpEvent>(HandleAddExpEvent);
        // }
